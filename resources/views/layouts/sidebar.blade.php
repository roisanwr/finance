<aside
    class="flex-1 bg-white dark:bg-gray-800 sudut-custom border border-gray-200 dark:border-gray-700 shadow-sm flex flex-col overflow-hidden"
        ...
        <ul class="space-y-1 px-3">
            ...
            <li>
                <a href="{{ route('wallets') }}"
                    class="flex items-center px-3 py-2.5 {{ request()->routeIs('wallets') ? 'bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-500 font-semibold' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white font-medium' }} rounded-lg transition-colors">
            ...
            <li>
                <a href="{{ route('categories') }}"
                    class="flex items-center px-3 py-2.5 {{ request()->routeIs('categories') ? 'bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-500 font-semibold' : 'text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white font-medium' }} rounded-lg transition-colors">
            ...
            <!-- Portofolio Section -->
            <li class="pt-5 pb-2 px-3">
                <span class="text-xs font-bold text-gray-400 dark:text-gray-500 tracking-wider">PORTOFOLIO &
                    INVESTASI</span>
            </li>
            <li>
                <a href="#"
